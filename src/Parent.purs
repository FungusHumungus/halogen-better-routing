...
type ChildSlots = ( roast :: Children.Slot Unit
                  ...
                  , potato :: Children.Slot Unit
                  , dud :: Children.Slot Unit
                  )
...
renderPane state = HH.div_ [ case state.currentRoute of
                               ...
                               R.Potato potato -> HH.slot _potato unit Children.potato potato absurd
                               R.Dud -> HH.slot _dud unit Children.dud unit absurd
                           ]
