...
(function($PS) {
  ...
  var renderSalad = function (v) {
      return Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#potato/Athlete") ])([ Halogen_HTML_Core.text("Athlete") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#potato/Pink Fir") ])([ Halogen_HTML_Core.text("Pink Fir") ]) ]) ]);
  };
  var salad = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: renderSalad,
      "eval": Halogen_Component.mkEval(Halogen_Component.defaultEval)
  });
  var renderRoast = function (v) {
      return Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#potato/Adrianne") ])([ Halogen_HTML_Core.text("Adrianne") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#potato/Carolus") ])([ Halogen_HTML_Core.text("Carolus") ]) ]) ]);
  };
  var roast = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: renderRoast,
      "eval": Halogen_Component.mkEval(Halogen_Component.defaultEval)
  });
  var renderPotato = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text(state) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Here is some fascinating and informative information pertaining to the " + (state + " potato")) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("It's a great potato. Amazing potato.") ]) ]);
  };
  var renderDud = function (v) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("An invalid route was selected") ]);
  };
  var renderChips = function (v) {
      return Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#potato/Maris Piper") ])([ Halogen_HTML_Core.text("Maris Piper") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#potato/Spanish Argia") ])([ Halogen_HTML_Core.text("Spanish Agria") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#potato/Cara") ])([ Halogen_HTML_Core.text("Cara") ]) ]) ]);
  };
  var potato = Halogen_Component.mkComponent({
      initialState: Control_Category.identity(Control_Category.categoryFn),
      render: renderPotato,
      "eval": Halogen_Component.mkEval(Halogen_Component.defaultEval)
  });
  var dud = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: renderDud,
      "eval": Halogen_Component.mkEval(Halogen_Component.defaultEval)
  });
  var chips = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](Data_Unit.unit),
      render: renderChips,
      "eval": Halogen_Component.mkEval(Halogen_Component.defaultEval)
  });
...
(function($PS) {
  ...
  var matches = (function () {
      var $16 = matchesWith(Data_Either.foldableEither);
      return function ($17) {
          return $16(Routing.match($17));
      };
  })();
...
(function($PS) {
  ...
  var Salad = (function () {
      ...
      Salad.value = new Salad();
      return Salad;
  })();
  var Potato = (function () {
      function Potato(value0) {
          this.value0 = value0;
      };
      Potato.create = function (value0) {
          return new Potato(value0);
      };
      return Potato;
  })();
  var Dud = (function () {
  ...
  var routing = Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Apply.applyFirst(Routing_Match.matchApply)(Control_Applicative.pure(Routing_Match.matchApplicative)(Roast.value))(Routing_Match.end))(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Roast.value)(Routing_Match.lit("roast")))(Routing_Match.end)))(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Chips.value)(Routing_Match.lit("chips")))(Routing_Match.end)))(Control_Apply.applyFirst(Routing_Match.matchApply)(Data_Functor.voidRight(Routing_Match.matchFunctor)(Salad.value)(Routing_Match.lit("salad")))(Routing_Match.end)))(Data_Functor.map(Routing_Match.matchFunctor)(Potato.create)(Control_Apply.applyFirst(Routing_Match.matchApply)(Control_Apply.applySecond(Routing_Match.matchApply)(Routing_Match.lit("potato"))(Routing_Match.str))(Routing_Match.end))))(Control_Applicative.pure(Routing_Match.matchApplicative)(Dud.value));
  var router = function (cb) {
      return Data_Functor["void"](Effect.functorEffect)(Routing_Hash.matches(routing)(function (_old) {
          return function ($$new) {
              return cb($$new);
          };
      }));
  ...
  var getRoute = function __do() {
      var v = Routing_Hash.getHash();
      return Data_Either.hush(Routing.match(routing)(v));
  };
  exports["Roast"] = Roast;
  exports["Chips"] = Chips;
  exports["Salad"] = Salad;
...
(function($PS) {
  ...
  var renderMenu = Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#roast") ])([ Halogen_HTML_Core.text("Roast") ]), Halogen_HTML_Core.text(" | "), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#chips") ])([ Halogen_HTML_Core.text("Chips") ]), Halogen_HTML_Core.text(" | "), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#salad") ])([ Halogen_HTML_Core.text("Salad") ]) ]);
  ...
  var handleQuery = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          ...
          $4.currentRoute = v.value0;
          return $4;
      }))(function () {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
      });
  };
  var _salad = Data_Symbol.SProxy.value;
  var _roast = Data_Symbol.SProxy.value;
  var _potato = Data_Symbol.SProxy.value;
  var _dud = Data_Symbol.SProxy.value;
  var _chips = Data_Symbol.SProxy.value;
  var renderPane = function (state) {
      return Halogen_HTML_Elements.div_([ (function () {
          if (state.currentRoute instanceof Router.Roast) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "roast";
              }))(Data_Ord.ordUnit)(_roast)(Data_Unit.unit)(Children.roast)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (state.currentRoute instanceof Router.Chips) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "chips";
              }))(Data_Ord.ordUnit)(_chips)(Data_Unit.unit)(Children.chips)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (state.currentRoute instanceof Router.Salad) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "salad";
              }))(Data_Ord.ordUnit)(_salad)(Data_Unit.unit)(Children.salad)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (state.currentRoute instanceof Router.Potato) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "potato";
              }))(Data_Ord.ordUnit)(_potato)(Data_Unit.unit)(Children.potato)(state.currentRoute.value0)(Data_Void.absurd);
          };
          if (state.currentRoute instanceof Router.Dud) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "dud";
              }))(Data_Ord.ordUnit)(_dud)(Data_Unit.unit)(Children.dud)(Data_Unit.unit)(Data_Void.absurd);
          };
          throw new Error("Failed pattern match at Parent (line 73, column 30 - line 78, column 83): " + [ state.currentRoute.constructor.name ]);
      })() ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ renderMenu, renderPane(state) ]);
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe(Router.Roast.value))(Router.getRoute)))(function (v1) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Parent.page)(v1)(v))(function (v2) {
              var changeRoute = function (route) {
                  return Effect_Aff.launchAff_(v2.query(Halogen_Query.tell(Parent.ChangeRoute.create(route))));
              };
